...
% Date: 9/9/2019
%
function [bounds,scaling] = getBounds_2D_mtp(NMuscle,nq,jointi)

%% Bounds
% Qs
bounds.Qs.upper = [30,4,1.0,70,70,10,10,45,45,60,60,30];
...
% Qdots
bounds.Qdots.upper = [5,6,2,10,10,20,20,10,10,10,10,5];
bounds.Qdots.lower = -bounds.Qdots.upper;
bounds.Qdots.lower(jointi.pelvis.tx) = 0;
% Qdotdots
bounds.Qdotdots.upper = [50,100,30,150,150,250,250,250,250,250,250,50];
