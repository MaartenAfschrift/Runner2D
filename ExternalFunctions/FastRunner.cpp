...
int F_generic(const T** arg, T** res) {
	...
	//// some artificial model parameters
	osim_double_adouble mTibia = 2;
	osim_double_adouble mcalcn = 0.5;
	osim_double_adouble mfemur = 4;
    /// Model
    ...
    femur_l = new OpenSim::Body("femur_l", mfemur, Vec3(0, -0.16734021487797751, 0), Inertia(0.10701920433197534, 0.028053577834595483, 0.11285370912378581, 0, 0, 0));
    femur_r = new OpenSim::Body("femur_r", mfemur, Vec3(0, -0.16734021487797751, 0), Inertia(0.10701920433197534, 0.028053577834595483, 0.11285370912378581, 0, 0, 0));
    tibia_l = new OpenSim::Body("tibia_l", mTibia, Vec3(0, -0.18635251395796504, 0), Inertia(0.041418155207686803, 0.004191122848396879, 0.041993407363349118, 0, 0, 0));
    tibia_r = new OpenSim::Body("tibia_r", mTibia, Vec3(0, -0.18635251395796504, 0), Inertia(0.041418155207686803, 0.004191122848396879, 0.041993407363349118, 0, 0, 0));
    ...
    calcn_l = new OpenSim::Body("calcn_l", mcalcn, Vec3(0.096184339663296911, 0.028855301898989071, 0), Inertia(0.0010683538270051544, 0.0029761285180857871, 0.003128750493372238, 0, 0, 0));
    calcn_r = new OpenSim::Body("calcn_r", mcalcn, Vec3(0.096184339663296911, 0.028855301898989071, 0), Inertia(0.0010683538270051544, 0.0029761285180857871, 0.003128750493372238, 0, 0, 0));
    ...
    osim_double_adouble dissipation = 0.5;
    osim_double_adouble staticFriction = 1.5;
    osim_double_adouble dynamicFriction = 1.5;
