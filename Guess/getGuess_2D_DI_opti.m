...
function guess = getGuess_2D_DI_opti(d,Qs,nq,N,time_IC,NMuscle,jointi,scaling,varargin)
...
if boolStride ==1
    ...
    isq = [1:6 9 10 7 8 13 14 11 12 17 18 15 16 19:20]; % flip L and R joint angles
